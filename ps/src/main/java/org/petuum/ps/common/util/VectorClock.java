...
public class VectorClock {
    /**
     * A map containing long values that can be atomically updated. While writes
     * to a traditional Map rely on put(K, V), the typical mechanism for writing
     * to this map is addAndGet(K, long), which adds a long to the value
     * currently associated with K. If a key has not yet been associated with a
     * value, its implicit value is zero.
     */
    ...
    /**
     * If the tick of this client will change the slowest_client_clock_, then it
     * returns true.
     */
    ...
    /**
     * Add a clock in vector clock with initial timestamp. id must be unique.
